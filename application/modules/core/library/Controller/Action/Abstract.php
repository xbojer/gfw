...
abstract class Core_Library_Controller_Action_Abstract extends Custom_Controller_Action_Abstract {
    ...
    public function preDispatch() {
        ...
        $this->view->headLink()->appendStylesheet('/css/core/style.less',false,array('rel'=>'stylesheet/less'));
        $this->view->headLink()->appendStylesheet('/css/core/gfwb.less',false,array('rel'=>'stylesheet/less'));
